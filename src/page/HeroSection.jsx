...
const HeroSection = () => {
  return (
    <div className="bg-[url('/images/hero-background.svg')] h-screen w-screen bg-blend-darken bg-repeat relative flex flex-col py-[103px] justify-center gap-48 overflow-hidden">
