...
const Button = ({ text, style, textColor }) => {
  return (
    <div className={`h-button w-fit flex flex-row gap-8 rounded-button justify-center items-center px-20  ${style}`}>
      <div className={`text-button uppercase ${textColor}`}>
        {text}
      </div>
